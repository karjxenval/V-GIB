...
def main():
    ...
    parser.add_argument("--save-root", type=str, default="./logs")
    parser.add_argument("--pretrained-vgg-path", type=str, default="./checkpoints/vgg11_bn-6002323d.pth")
    ...
    parser.add_argument("--pretrained-vgg-path", type=str,
                        default=r"C:\Users\DELL\.cache\torch\hub\checkpoints\vgg11_bn-6002323d.pth")
